...
const LoginView: React.FC<LoginViewProps> = ({ onNavigate }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            onNavigate('simulation'); // Redirect to dashboard on successful login
        } catch (err) {
        ...
        <AuthLayout title="Connectez-vous à votre compte">
            <form className="space-y-6" onSubmit={handleSubmit}>
             ...
             <div className="mt-6">
                ...
                <div className="mt-6">
                    <a href="#signup" onClick={(e) => { e.preventDefault(); onNavigate('signup'); }} className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700">
                        Créer un compte
                    </a>
                </div>
            </div>

    ...
    <AuthLayout title="Rejoignez Welloh">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="border-t border-white/10 pt-6">
          <p className="text-sm font-medium text-gray-400 mb-4">Informations personnelles</p>
          ...
          <div className="space-y-4">
            <NeonInput
              ...
              onChange={handleChange}
              disabled={isLoading}
              placeholder="Ex: Senegal, Cote d'Ivoire..."
              icon={<GlobeAltIcon className="w-5 h-5" />}
              iconPosition="left"
            />

            <NeonInput
              label="Institution (Universite/Entreprise)"
              type="text"
              name="institution"
              required
